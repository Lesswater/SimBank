   ...
   public void completeTransaction(String[]currentTransaction){
      ...
      if(firstIndex>=0){
          if (secondIndex>=0){
              ...
              firstBalance= Integer.parseInt(Shared.masterAccounts[firstIndex][1]) - Integer.parseInt(currentTransaction[3]);
              
              if (firstBalance>=0){
                  secondBalance= Integer.parseInt(Shared.masterAccounts[secondIndex][1]) + Integer.parseInt(currentTransaction[3]);
                  
                  Shared.masterAccounts[firstIndex][1] = Integer.toString(firstBalance);
                  Shared.masterAccounts[secondIndex][1] = Integer.toString(secondBalance);
